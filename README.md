...
I’ve always been fascinated by the history of compilers. So I compiled the same C benchmark(index-c) with GCC from 4 to 16 and Clang from 3 to 23 to see how compilers evolved.
